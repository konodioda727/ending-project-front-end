...
const Rank: React.FC = () => {
  return (
    <View>
        <OrderedElem><div className='rank-title-box'><div className='rank-title'>华师年度巅峰榜</div></div></OrderedElem>
            <OrderedElem>
            <div className='rank-box rank-box-1'>
            ...
            <OrderedElem>
            <div className='rank-box rank-box-2'>
                <div className='rank-content'>
            ...
            <OrderedElem>
            <div className='rank-box rank-box-3'>
                <div className='rank-content'>
            ...
            <OrderedElem>
            <div className='rank-box rank-box-4'>
                <div className='rank-content'>
